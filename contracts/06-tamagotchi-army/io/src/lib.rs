...
use tamagotchi_utils_io::{TmgAction, TmgEvent, TmgInit};
...
impl TamagotchiFactory {
    ...
    pub async fn get_tamagotchi_name(&self, tamagotchi_id: TamagotchiId) {
        ...
        let tamagotchi_name_response = send_message(&tamagotchi_address, TmgAction::Name).await;

        if let TmgEvent::Name(tamagotchi_name) = tamagotchi_name_response {
    ...
    pub async fn get_tamagotchi_age(&self, tamagotchi_id: TamagotchiId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_age_response = send_message(&tamagotchi_address, TmgAction::Age).await;

        if let TmgEvent::Age(tamagotchi_age) = tamagotchi_age_response {
    ...
    pub async fn feed_tamagotchi(&self, tamagotchi_id: TamagotchiId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_response = send_message(&tamagotchi_address, TmgAction::Feed).await;
    ...
    pub async fn play_with_tamagotchi(&self, tamagotchi_id: TamagotchiId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_response = send_message(&tamagotchi_address, TmgAction::Entertain).await;
    ...
    pub async fn sleep_tamagotchi(&self, tamagotchi_id: TamagotchiId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_response = send_message(&tamagotchi_address, TmgAction::Sleep).await;
    ...
    pub async fn transfer_tamagotchi(&self, tamagotchi_id: TamagotchiId, new_owner: ActorId) {
        ...
        let tamagotchi_response =
            send_message(&tamagotchi_address, TmgAction::Transfer(new_owner)).await;
    ...
    pub async fn approve_user(&self, tamagotchi_id: TamagotchiId, user: ActorId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_response = send_message(&tamagotchi_address, TmgAction::Approve(user)).await;
    ...
    pub async fn revoke_approval(&self, tamagotchi_id: TamagotchiId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_response =
            send_message(&tamagotchi_address, TmgAction::RevokeApproval).await;
    ...
    pub async fn set_ft_token_contract_to_tamagotchi(
        ...
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_response = send_message(
            &tamagotchi_address,
    ...
    pub async fn check_tamagotchi_state(&self, tamagotchi_id: TamagotchiId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_response = send_message(&tamagotchi_address, TmgAction::CheckState).await;
...
pub async fn send_message(tamagotchi_address: &ActorId, tamagotchi_payload: TmgAction) -> TmgEvent {
